...
namespace Lambda.Host
{
    ...
    file static class LambdaHostMapHandlerExtensions
    {
        ...
        [InterceptsLocation(1, "gAr8/MhaLWyqGSlu7w/fHxEBAABJbnB1dEZpbGUuY3M=")]
        ...
        )
        {
            ...
            Stream Serializer(ILambdaHostContext context)
            {
                ...
                var response = context.GetResponse<global::IService>() ?? throw new InvalidOperationException($"Lambda response of type '{typeof(global::IService).FullName}' is not available in the context.");
                var outputStream = new MemoryStream();
                outputStream.SetLength(0L);
                context.LambdaSerializer.Serialize<global::IService>(response, outputStream);
