...
public class LambdaApplication : global::Lambda.Host.LambdaHostedService
{
    ...
    public override global::System.Threading.Tasks.Task StartAsync(global::System.Threading.CancellationToken cancellationToken)
    {
        ...
        if (this._delegateHolder.Handler is not global::System.Func<string, global::Amazon.Lambda.Core.ILambdaContext, global::IService, string> lambdaHandler)
        ...
        global::Amazon.Lambda.RuntimeSupport.LambdaBootstrapBuilder
            .Create(
                (string input, global::Amazon.Lambda.Core.ILambdaContext context) => 
                {
                    ...
                    var __response = lambdaHandler(input, context, service);
