...
[TestSubject(typeof(ApiGatewayV2ResponseEnvelope<>))]
public class ApiGatewayV2ResponseEnvelopeTests
{
    ...
    {
        // Arrange
        var envelope = new ApiGatewayV2ResponseEnvelope<ResponsePayload> { BodyContent = null };
        var options = new EnvelopeOptions();
    ...
    [Fact]
    public void ApiGatewayV2ResponseEnvelope_InheritsFromAPIGatewayHttpApiV2ProxyResponse()
    {
        // Arrange & Act
        var envelope = new ApiGatewayV2ResponseEnvelope<ResponsePayload>();

        // Assert
        envelope.Should().BeAssignableTo<APIGatewayHttpApiV2ProxyResponse>();
    }
    ...
    {
        // Arrange
        var envelope = new ApiGatewayV2ResponseEnvelope<string> { BodyContent = string.Empty };
        var options = new EnvelopeOptions();
