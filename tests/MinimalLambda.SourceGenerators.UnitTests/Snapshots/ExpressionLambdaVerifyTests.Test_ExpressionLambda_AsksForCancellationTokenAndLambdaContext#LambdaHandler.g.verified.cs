...
namespace MinimalLambda.Generated
{
    ...
    file static class GeneratedLambdaInvocationBuilderExtensions
    {
        ...
        [InterceptsLocation(1, "E0m79hZz+OhoP5DYhe70YeAAAABJbnB1dEZpbGUuY3M=")]
        internal static ILambdaInvocationBuilder MapHandlerInterceptor0(
            this ILambdaInvocationBuilder application,
            Delegate handler
        )
        {
            var castHandler = Utilities.Cast(handler, string (global::System.Threading.CancellationToken arg0, global::Amazon.Lambda.Core.ILambdaContext arg1) => throw null!);
            ...
            Task InvocationDelegate(ILambdaHostContext context)
            {
                ...
                // ParameterInfo { Type = global::Amazon.Lambda.Core.ILambdaContext, Name = ctx, Source = HostContext, IsNullable = False, IsOptional = False}
                var arg1 = context;
