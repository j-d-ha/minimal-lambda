...
internal static class UseMiddlewareTSource
{
    internal static string Generate(EquatableArray<UseMiddlewareTInfo> useMiddlewareTInfos)
    {
        ...
        //         {
        //             var fromArgs = p.AttributeNames.Any(n => n ==
        // AttributeConstants.FromArguments);
        //
        ...
        //                 n is AttributeConstants.FromServices or
        // AttributeConstants.FromKeyedService
        //             );
        //
        ...
        return TemplateHelper.Render(
            GeneratorConstants.UseMiddlewareTTemplateFile,
            new { MinimalLambdaEmitter.GeneratedCodeAttribute, Calls = useMiddlewareTInfos }
        );
    }
