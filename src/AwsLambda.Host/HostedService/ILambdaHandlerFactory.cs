...
/// <summary>
/// Responsible for creating and composing the Lambda handler.
/// Handles middleware pipeline composition and request execution wrapping.
/// </summary>
internal interface ILambdaHandlerFactory
{
    ...
    /// and request processing (serialization, deserialization, context management).
    /// The handler, middleware, and all state are obtained from dependency injection.
    /// </summary>
