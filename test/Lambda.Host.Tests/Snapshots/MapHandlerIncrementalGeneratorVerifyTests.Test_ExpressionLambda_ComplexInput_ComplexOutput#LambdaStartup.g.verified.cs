...
public class LambdaStartupService : IHostedService
{
    ...
    public async global::System.Threading.Tasks.Task StartAsync(global::System.Threading.CancellationToken cancellationToken)
    {
        ...
        if (_delegateHolder.Handler is not Func<global::CustomRequest, global::IService, global::Amazon.Lambda.Core.ILambdaContext, global::System.Threading.Tasks.Task<global::CustomResponse>> lambdaHandler)
        ...
        await global::Amazon.Lambda.RuntimeSupport.LambdaBootstrapBuilder
            .Create(
                async (global::CustomRequest request, global::Amazon.Lambda.Core.ILambdaContext context) => 
                {
                    ...
                    var response = await lambdaHandler(request, service, context);
